...
from diffusion_maps import comp_laplacian_eigendec, compute_similarity_matrix
...
def main():
  ...
  W = compute_similarity_matrix(data, sigma=0.1)
  phi, Sigma = comp_laplacian_eigendec(W, sigma=0.1, n_eigenvectors=15)
  ...
  rect3d_phi = rect3d_results['egvecs']
  ...
  cryo_em_phi = cryo_em_results['egvecs']
  ...
  steps = [5, 95, 15]
  plot_product_sims(rect3d_mixtures, rect3d_results['egvecs'], rect3d_results['egvals'], steps,
  ...
  torus_phi = torus_results['egvecs']
